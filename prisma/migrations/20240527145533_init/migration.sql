...
CREATE TABLE "Software_Setting" (
    ...
    CONSTRAINT "Software_Setting_pkey" PRIMARY KEY ("id","clientId","softwareLabel")
);

-- CreateTable
CREATE TABLE "Software_Setting_Value" (
    "id" TEXT NOT NULL,
    "clientId" TEXT NOT NULL,
    "softwareLabel" TEXT NOT NULL,
    "softwareSettingId" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "Software_Setting_Value_pkey" PRIMARY KEY ("id","clientId","softwareLabel","softwareSettingId")
);
...
CREATE TABLE "Default_Setting" (
    ...
    CONSTRAINT "Default_Setting_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "Default_Setting_Value" (
    "id" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "value" TEXT NOT NULL,
    "defaultSettingId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdBy" TEXT NOT NULL DEFAULT 'system',

    CONSTRAINT "Default_Setting_Value_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Form" (
    ...
    "clientId" TEXT,
    "originalFormId" TEXT,
    "originalFormVersion" INTEGER,
    "buttonLabel" TEXT NOT NULL DEFAULT 'Valider',
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdBy" TEXT NOT NULL DEFAULT 'system',
    "isArchived" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Form_Group" (
    ...
    CONSTRAINT "Form_Group_pkey" PRIMARY KEY ("formId","formVersion","formGroup")
);
...
CREATE TABLE "Page_Block_Form" (
    ...
    CONSTRAINT "Page_Block_Form_pkey" PRIMARY KEY ("formId","formVersion","pageBlockId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Software_Setting_clientId_softwareLabel_label_key" ON "Software_Setting"("clientId", "softwareLabel", "label");

-- CreateIndex
CREATE UNIQUE INDEX "Software_Setting_Value_slug_key" ON "Software_Setting_Value"("slug");
...
-- CreateIndex
CREATE UNIQUE INDEX "Form_clientId_softwareLabel_repository_key" ON "Form"("clientId", "softwareLabel", "repository");

-- CreateIndex
CREATE UNIQUE INDEX "FormField_slug_key" ON "FormField"("slug");

-- CreateIndex
CREATE UNIQUE INDEX "Page_Block_Form_pageBlockId_key" ON "Page_Block_Form"("pageBlockId");
...
-- AddForeignKey
ALTER TABLE "Software_Setting_Value" ADD CONSTRAINT "Software_Setting_Value_softwareLabel_clientId_softwareSett_fkey" FOREIGN KEY ("softwareLabel", "clientId", "softwareSettingId") REFERENCES "Software_Setting"("softwareLabel", "clientId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Default_Setting_Value" ADD CONSTRAINT "Default_Setting_Value_defaultSettingId_fkey" FOREIGN KEY ("defaultSettingId") REFERENCES "Default_Setting"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Form_Group" ADD CONSTRAINT "Form_Group_formId_formVersion_fkey" FOREIGN KEY ("formId", "formVersion") REFERENCES "Form"("id", "version") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Form_Group" ADD CONSTRAINT "Form_Group_clientId_projectLabel_softwareLabel_fkey" FOREIGN KEY ("clientId", "projectLabel", "softwareLabel") REFERENCES "Project"("clientId", "label", "softwareLabel") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Form_Group" ADD CONSTRAINT "Form_Group_softwareLabel_clientId_fkey" FOREIGN KEY ("softwareLabel", "clientId") REFERENCES "Software"("label", "clientId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Form_Value" ADD CONSTRAINT "Form_Value_clientId_projectLabel_softwareLabel_fkey" FOREIGN KEY ("clientId", "projectLabel", "softwareLabel") REFERENCES "Project"("clientId", "label", "softwareLabel") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Form_Value" ADD CONSTRAINT "Form_Value_formId_formVersion_formGroupId_fkey" FOREIGN KEY ("formId", "formVersion", "formGroupId") REFERENCES "Form_Group"("formId", "formVersion", "formGroup") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Form_Value" ADD CONSTRAINT "Form_Value_softwareLabel_clientId_fkey" FOREIGN KEY ("softwareLabel", "clientId") REFERENCES "Software"("label", "clientId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FormField" ADD CONSTRAINT "FormField_sourceDsnId_fkey" FOREIGN KEY ("sourceDsnId") REFERENCES "Dsn_Structure"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FormField" ADD CONSTRAINT "FormField_formId_formVersion_fkey" FOREIGN KEY ("formId", "formVersion") REFERENCES "Form"("id", "version") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Page_Block_Form" ADD CONSTRAINT "Page_Block_Form_pageBlockId_fkey" FOREIGN KEY ("pageBlockId") REFERENCES "Page_Block"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Page_Block_Form" ADD CONSTRAINT "Page_Block_Form_formId_formVersion_fkey" FOREIGN KEY ("formId", "formVersion") REFERENCES "Form"("id", "version") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Page_Block_Form" ADD CONSTRAINT "Page_Block_Form_softwareLabel_clientId_fkey" FOREIGN KEY ("softwareLabel", "clientId") REFERENCES "Software"("label", "clientId") ON DELETE CASCADE ON UPDATE CASCADE;
