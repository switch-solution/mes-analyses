...
export async function formV0001Seed() {
    try {
        const SEED_NAME = "FORM_V0001"
            ...
            await prisma.form.upsert({
                ...
                update: {
                    ...
                    Form_Input: {
                        ...
                        {
                            type: 'text',
                            dsnType: 'dsnEstablishmentAddress1',
                            label: 'Adresse',
                            maxLength: 50,
                            minLength: 1,
                            placeholder: "Rue du test",
                        ...
                        {
                            type: 'text',
                            dsnType: 'dsnEstablishmentAddress2',
                            label: 'Complément adresse',
                            maxLength: 50,
                            minLength: 1,
                            placeholder: "Batiment A",
                        ...
                        },
                        {
                            ...
                            type: 'text',
                            dsnType: 'dsnEstablishmentAddress3',
                            label: 'Adresse 3',
                            maxLength: 50,
                            minLength: 1,
                            placeholder: "Service paie",
                        ...
                        {
                            type: 'text',
                            dsnType: 'dsnEstablishmentZipCode',
                            label: 'code postal',
                            maxLength: 5,
                            minLength: 1,
                            placeholder: "75000",
