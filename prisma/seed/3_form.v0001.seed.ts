    ...
    async run() {
        ...
        try {
            if (previousStatus && !seedExist) {
                ...
                await prisma.form.create({
                    data: {
                        id: 'Standard_Formulaire_interface_sortante',
                        label: 'Création interface sortante',
                        slug: 'Standard_Formulaire_0011',
                        description: 'Création des interfaces sortantes',
                        version: 1,
                        Form_Input: {
                            create: [
                                {
                                ...
                                },
                                {
                                    ...
                                    required: true,
                                    order: 2,
                                    slug: 'Standard_Champ_0054',
                                },
                                {
                                    id: 'Standard_Champ_0003',
                                    type: 'textara',
                                    zodLabel: 'description',
                                    label: 'Description de l\'interface',
                                    required: true,
                                    order: 3,
                                    slug: 'Standard_Champ_0055',
                                },
                                {
                                    id: 'Standard_Champ_0004',
                                    type: 'textarea',
...
export const formV0001 = new FormV0001("FORM_V0001", "Création de processus structure juridique", 3, "IDCC_V0001")
