...
export const createIndice = authentifcationActionUserIsAuthorizeToEditProject(CreateClassificationSchema, async (values: z.infer<typeof CreateClassificationSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
    ...
    const echelonExist = await processus.valueExist({
        value: id,
        clientId,
        projectLabel,
        softwareLabel
...
export const updateIndice = authentifcationActionUserIsAuthorizeToEditProject(ClassificationEditSchema, async (values: z.infer<typeof ClassificationEditSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
