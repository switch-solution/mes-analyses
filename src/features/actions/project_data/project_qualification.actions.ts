...
export const createQualification = authentifcationActionUserIsAuthorizeToEditProject(CreateClassificationSchema, async (values: z.infer<typeof CreateClassificationSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
    ...
    const qualificationExist = await processus.valueExist({
        value: id,
        clientId,
        projectLabel,
        softwareLabel
...
export const updateQualification = authentifcationActionUserIsAuthorizeToEditProject(ClassificationEditSchema, async (values: z.infer<typeof ClassificationEditSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
