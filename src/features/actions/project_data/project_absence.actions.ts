...
export const updateAbsence = authentifcationActionUserIsAuthorizeToEditProject(ProjectAbsenceEditSchema, async (values: z.infer<typeof ProjectAbsenceEditSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
    const { clientSlug, processusSlug, projectSlug, } = ProjectAbsenceEditSchema.parse(values)
