...
export const createCoefficient = authentifcationActionUserIsAuthorizeToEditProject(CreateClassificationSchema, async (values: z.infer<typeof CreateClassificationSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
    ...
    const coeffExist = await processus.valueExist({
        value: id,
        clientId,
        projectLabel,
        softwareLabel
...
export const updateCoefficient = authentifcationActionUserIsAuthorizeToEditProject(ClassificationEditSchema, async (values: z.infer<typeof ClassificationEditSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
