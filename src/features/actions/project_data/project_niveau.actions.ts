...
export const updateNiveau = authentifcationActionUserIsAuthorizeToEditProject(ClassificationEditSchema, async (values: z.infer<typeof ClassificationEditSchema>, { clientId, userId, softwareLabel, projectLabel }) => {
