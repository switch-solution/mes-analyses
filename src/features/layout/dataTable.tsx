...
/**
 *Retourne un tableau de données avec des fonctionnalités de tri, de filtre et de visibilité des colonnes 
 *Le param href contient la route de base. 
 Par exemple : /editor/component/ le résultat sera
    la route open : /editor/component/:id
    la route edit : /editor/component/:id/edit
    la route delete : /editor/component/:id/delete
 * @returns 
 */
