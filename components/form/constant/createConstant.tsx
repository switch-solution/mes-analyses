...
export default function CreateSoftwareConstant({ clientSlug, softwareSlug, idcc }: { clientSlug: string, softwareSlug: string, idcc: string }) {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Valeur</FormLabel>
                            <FormControl>
                                <Input type="date" placeholder="5" {...field} required />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
