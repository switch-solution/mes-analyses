...
import { createSoftwareComponentForm } from "@/src/features/actions/software_component/software_component.actions"
import { Input } from '@/components/ui/input'
import { toast } from "sonner"

export default function CreateSoftwareComponentForm({ clientSlug, softwareSlug }: { clientSlug: string, softwareSlug: string }) {
    ...
    const onSubmit = async (data: z.infer<typeof SoftwareComponentCreateSchema>) => {
        try {
            setLoading(true)
            const action = await createSoftwareComponentForm(data)
