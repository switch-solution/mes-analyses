import CreateSoftwareSettingValue from "@/components/form/software_setting/createSoftwareSettingValue";
...
export default async function Page({ params }: { params: { clientSlug: string, softwareSlug: string, settingSlug: string } }) {
    ...
    return (<Container>
        ...
        <ContainerForm>
            <CreateSoftwareSettingValue clientSlug={params.clientSlug} softwareSlug={params.softwareSlug} settingSlug={params.settingSlug} />
        </ContainerForm>
    </Container>)
}