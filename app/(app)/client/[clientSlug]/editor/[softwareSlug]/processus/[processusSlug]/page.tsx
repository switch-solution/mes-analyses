...
export default async function Page({ params }: { params: { clientSlug: string, softwareSlug: string, processusSlug: string } }) {
    ...
    const formList = await processus.getForm()
    ...
    return (
        <Container>
            ...
            <ContainerDataTable>
                <DataTable columns={columns} data={forms} inputSearch="id" inputSearchPlaceholder="Chercher par code processus" href={`/client/${params.clientSlug}/editor/${params.softwareSlug}/processus/create`} buttonLabel="Créer un nouveau processus" />
            </ContainerDataTable>
        </Container>
    )
}