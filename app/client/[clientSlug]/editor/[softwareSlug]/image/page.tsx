...
import { getComponentImage } from "@/src/query/software_component.query"
...
export default async function Page({ params }: { params: { clientSlug: string, softwareSlug: string } }) {
    ...
    const softwareTableList = await getComponentImage()
    ...
    return (
        <Container>
            ...
            <DataTable columns={columns} data={table} inputSearch="id" inputSearchPlaceholder="Chercher par code" href={`/client/${params.clientSlug}/editor/${params.softwareSlug}/image/create`} buttonLabel="Ajouter une image" />
        </Container>
